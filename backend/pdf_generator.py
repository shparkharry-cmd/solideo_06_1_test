...
class PDFReportGenerator:
    ...
    def _create_cpu_chart(self):
        ...
        ax.set_title('CPU Usage Trend', fontsize=12, fontweight='bold')
    ...
    def _create_memory_chart(self):
        ...
        ax.set_xlabel('Time (seconds)', fontsize=10)
        ax.set_ylabel('Memory Usage (%)', fontsize=10)
        ax.set_title('Memory Usage Trend', fontsize=12, fontweight='bold')
        ax.grid(True, alpha=0.3)
        ax.set_ylim(0, 100)
    ...
    def _create_network_chart(self):
        ...
        fig, ax = plt.subplots(figsize=(10, 4))
        ax.plot(timestamps, upload, linewidth=2, color='#2ecc71', label='Upload')
        ax.plot(timestamps, download, linewidth=2, color='#9b59b6', label='Download')
        ax.fill_between(timestamps, upload, alpha=0.3, color='#2ecc71')
        ax.fill_between(timestamps, download, alpha=0.3, color='#9b59b6')
        ax.set_xlabel('Time (seconds)', fontsize=10)
        ax.set_ylabel('Speed (MB/s)', fontsize=10)
        ax.set_title('Network Speed Trend', fontsize=12, fontweight='bold')
        ax.legend()
        ax.grid(True, alpha=0.3)
    ...
    def _create_temperature_chart(self):
        ...
        ax.set_title('CPU Temperature Trend', fontsize=12, fontweight='bold')
        ax.grid(True, alpha=0.3)
